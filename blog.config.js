...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '7a33348493a241099228f806e33b5a8c',
  ...
  AUTHOR: 'Ebichu', // 您的昵称 例如 tangly1024
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ebichu.vercel.app', // 网站地址
